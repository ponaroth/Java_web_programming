...
@WebServlet(urlPatterns = { "/photos/Download", "/image.jpg", "/ViewImage" })
...
//    	models.Photo photo = getPhoto(albumId, photoId);
		...
		String path = getServletContext().getRealPath("/WEB-INF/uploads/album.jpg"); // " + photo.getFilename() );
		...
		response.setHeader("Content-Disposition", "inline; filename=FlockOf.jpg");
