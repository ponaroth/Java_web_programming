...
<body>
	...
	<table border="1" cellpadding="2" cellspacing="2">
		...
		<c:forEach items="${entries}" var="entry">
			<tr>
				...
				<td>
					<center>
						<a style="text-decoration: none;" href='Edit?id=${entry.id}'><button>Edit</button></a>
	...
	<p>
		<a style="text-decoration: none;" href="AddComment">Add Comment</a>
	</p>
