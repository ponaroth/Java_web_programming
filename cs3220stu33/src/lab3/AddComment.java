...
@WebServlet(urlPatterns ="/lab3/AddComment")
public class AddComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (isValidName && isValidMessage) {
			...
			ArrayList<MyGuestBookEntry> guestbookEntries = (ArrayList<MyGuestBookEntry>) getServletContext().getAttribute("guestbookEntries");
			
			// Add a new entry
			guestbookEntries.add(new MyGuestBookEntry(name, message));
