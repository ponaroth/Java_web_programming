	...
	<form action="Rating" method="post">
		...
		<table cellspacing="2" cellpadding="5" border="1">
			<tbody>
				...
				<c:forEach items="${raterList}" var="entry">
				<tr>
					<td>Rating: ${entry.rating}</td>
					<td style="text-align: right;">Posted by ${entry.rater} on <fmt:formatDate value="${entry.date}" type="date" />
				</tr>
				<tr>
					<td colspan="2">${entry.comment}&nbsp;</td>
